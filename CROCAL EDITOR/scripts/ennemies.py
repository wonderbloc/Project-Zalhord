...
class obj_ennemy(pygame.sprite.Sprite): #Création du perso
    ...
    def draw_ennemy(self,surface):
            ...
            if self.id == "rusher":
                ...
                if self.id == "mirror":
                    ...
                    if self.life_time < wait-12:
                        ...
                        pygame.draw.line(surface,(255,(self.life_time%2)*255,0),((self.rect.x+32)*self.flip[0],(self.rect.y+32)*self.flip[1]),(self.rect.x + screen_size[0]*int(not(self.flip[0]))+32,self.rect.y +screen_size[1]*int(not(self.flip[1]))+32),3)
                    else:
        ...
        if self.rect.x < 0 or self.rect.x > screen_size[0]: 
            self.actif = False
        elif (self.rect.y < 0 or self.rect.y > screen_size[1]) and self.id != "bounce":
            self.actif = False
